...
const PricingSection = () => {
  const features = [
    "Veröffentlichung von Frachten auf TRANS, TIMOCOM, TELEROUTE",
    "KI zur Erstellung von Angeboten aus Bildern",
    "Mailing 4.0",
    "WhatsApp",
    "Automatische Aktualisierung von Frachtangeboten auf Börsen",
    "Integration mit E-Mail-Postfach, Branding des Mailings von Frachtlisten (E-Mail-Titel, Logo in E-Mail)",
    "Automatische Suche nach freien Fahrzeugen auf TIMOCOM im Umkreis von 100 km vom Beladeort",
    "Statistiken für Spediteur und Manager"
  ];
  ...
  const plans = [
    {
      planName: "Start",
      price: "60 € / Monat",
      usersIncluded: "3 Benutzer im Preis inbegriffen",
      additionalUserPrice: "15 € (netto) Gebühr für zusätzlichen Benutzer",
    ...
    },
    {
      planName: "Standard",
      price: "100 € / Monat",
      usersIncluded: "6 Benutzer im Preis inbegriffen",
      additionalUserPrice: "10 € (netto) Gebühr für zusätzlichen Benutzer",
    ...
    },
    {
      planName: "Corporate",
      price: "200 € / Monat",
      usersIncluded: "30 Benutzer im Preis inbegriffen",
      additionalUserPrice: "10 € (netto) Gebühr für zusätzlichen Benutzer",
  ...
  return (
    <section id="cennik" className="w-[1200px] max-w-full mt-60 max-md:mt-10 scroll-mt-24">
      <h2 className="text-czarny text-center text-[42px] font-barlow-condensed font-semibold tracking-[1.26px] max-md:max-w-full">
        Wählen Sie einen Plan und Arbeitsplätze für sich
      </h2>
